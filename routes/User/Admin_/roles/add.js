...
const { addNewRole } = require("../../../../controllers/Admin/roleController.js");
...
router.post(
  ...
  [
    ...
    body("role_description").trim().notEmpty().withMessage("Role Description required").escape(),
  ],
  (req, res, next) => {
    (async () => {
